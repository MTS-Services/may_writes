...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::redirect('/files', '/admin/writing-requests')->name('files');
    Route::get('/writing-requests', [AdminWritingRequestController::class, 'index'])->name('writing-requests');
    Route::patch('/writing-requests/{task}/workflow-status', [AdminWritingRequestController::class, 'updateWorkflowStatus'])->name('writing-requests.workflow-status');
    Route::get('/writing-requests/versions/{version}/download', [AdminWritingRequestController::class, 'downloadVersion'])->name('writing-requests.versions.download');
