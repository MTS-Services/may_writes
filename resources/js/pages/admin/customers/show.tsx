    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-wrap items-end justify-between gap-4">
                ...
                <Badge
                    variant={statusBadgeVariant(customer.status)}
            ...
            <Card className="overflow-hidden rounded-xl border pt-0 shadow-sm">
                        ...
                        <>
                            <SheetHeader className="border-b px-6 py-5 text-left">
                                ...
                                <SheetDescription className="text-left">
                                    {selectedTask.versions_count} version
                                    {selectedTask.versions_count === 1
                                        ? ''
                                        : 's'}{' '}
                                    · {selectedTask.workflow_label}
                                    {selectedTask.pipeline_status
                                        ? ` · ${selectedTask.pipeline_status}`
                                        : ''}
                                </SheetDescription>
                            </SheetHeader>
                            <div className="flex-1 overflow-y-auto">
                                {selectedTask.versions.length === 0 ? (
                                    ...
                                    <Table>
                                        ...
                                        <TableBody>
                                            {selectedTask.versions.map(
                                                (version) => (
                                                    <TableRow key={version.id}>
                                                        <TableCell className="flex items-center justify-start gap-2 pl-6">
                                ...
                                {/* {selectedTask.versions.some(
                                    (v) => v.document_filename,
                                ) ? (
